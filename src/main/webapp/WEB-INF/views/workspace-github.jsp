	...
	<div class="wrapper">
        ...
        <nav class="navbar-fixed-left">
            ...
            <a href="workspace-map.html" class="shelf-button--map"><i class="fas fa-map-marked-alt"
                    style="font-size: 1rem; color:rgb(255, 248, 248);"></i></a>
            <a href="workspace-github.html" class="shelf-button--github" style="background-color:rgb(56, 56, 56)"><i class="fab fa-github"
        ...
        <div class="left-sidebar">
            <div id="left-sidebar-toggle">
                <div class="shlef-button-title" style="color:rgb(56, 56, 56)"><i class="fab fa-github" style="font-size: 1.3rem;"></i>&nbsp Team Github</div>
                <div class="shelf-button-contents">
                    <div class="shelf-button-contents-label">Label</div>
                    <div class="shelf-button-contents-select" style="background-color:rgb(56, 56, 56); color:white;">Test menu 1</div>
