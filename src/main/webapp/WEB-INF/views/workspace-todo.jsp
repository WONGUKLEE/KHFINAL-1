	 ...
	 <div class="wrapper">
        ...
        <nav class="navbar-fixed-left">
            ...
            <a href="workspace-calendar.html" class="shelf-button--calendar"><i class="fas fa-calendar-alt"
                    style="font-size: 1rem; color:rgb(255, 248, 248);"></i></a>
            <a href="workspace-todo.html" class="shelf-button--todo" style="background-color:rgb(253, 80, 80)"><i class="fas fa-check"
                    style="font-size: 1rem; color:rgb(255, 248, 248);"></i></a>
        ...
        <div class="left-sidebar">
            <div id="left-sidebar-toggle">
                <div class="shlef-button-title" style="color:rgb(253, 80, 80)"><i class="fas fa-check"></i>&nbsp Team To Do</div>
                <div class="shelf-button-contents">
                    <div class="shelf-button-contents-label">Label</div>
                    <div class="shelf-button-contents-select" style="background-color:rgb(253, 80, 80); color:white;">Test menu 1</div>
