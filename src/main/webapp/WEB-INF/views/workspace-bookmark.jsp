...
<body>
	<div class="wrapper">
        ...
        <nav class="navbar-fixed-left">
            ...
            <a href="workspace-bookmark.html" class="shelf-button--bookmark" style="background-color:rgb(132, 210, 255)"><i class="fas fa-bookmark"
                    style="font-size: 1rem; color:rgb(255, 248, 248);"></i></a>
        </nav>
        ...
        <div class="left-sidebar">
            <div id="left-sidebar-toggle">
                <div class="shlef-button-title" style="color:rgb(132, 210, 255)"><i class="fas fa-bookmark"></i>&nbsp Team Bookmark</div>
                <div class="shelf-button-contents">
                    <div class="shelf-button-contents-label">Label</div>
                    <div class="shelf-button-contents-select" style="background-color:rgb(132, 210, 255); color:white;">Test menu 1</div>
