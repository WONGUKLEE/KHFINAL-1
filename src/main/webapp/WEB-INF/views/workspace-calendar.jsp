	...
	<div class="wrapper">
        ...
        <nav class="navbar-fixed-left">
            ...
            <a href="workspace-board.html" class="shelf-button--board"><i class="fas fa-pen"
                    style="font-size: 1rem; color:rgb(255, 248, 248);"></i></a>
            <a href="workspace-calendar.html" class="shelf-button--calendar" style="background-color:rgb(230, 119, 252)"><i class="fas fa-calendar-alt"
                    style="font-size: 1rem; color:rgb(255, 248, 248);"></i></a>
        ...
        <div class="left-sidebar">
            <div id="left-sidebar-toggle">
                <div class="shlef-button-title" style="color:rgb(230, 119, 252)"><i class="fas fa-calendar-alt"></i>&nbsp Team Calendar</div>
                <div class="shelf-button-contents">
                    <div class="shelf-button-contents-label">Label</div>
                    <div class="shelf-button-contents-select" style="background-color:rgb(230, 119, 252); color:white;">Test menu 1</div>
